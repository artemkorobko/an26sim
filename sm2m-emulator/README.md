# SM2M Emulator
SM2M Emulator is the emulator of the SM2M computing units which can generate signals sent from SM2M and receive signals sent from SM2M encoder. The firmware is developed for STM32F103C8T6 MCU. It is build using the RTIC - a concurrency framework for building real-time systems. You can find more information in the official RTIC book https://rtic.rs/0.5/book/en/.
